import { genInt, sample, constant, elements, frequency, oneof, vectorOf, listOf, listOf1, choose } from './gen';
...
const result14 = quickCheckResult(withMaxSuccess(200, forAll(choose(1, 10), prop_Good4)));
