import { genInt, sample, constant, elements, frequency, oneof, vectorOf, listOf, listOf1 } from './gen';
...
const prop_Good4WithLogging = n => label(`n: ${n}`, (console.log(`[prop_Good4] n: ${n}`), n + n === 2 * n));
...
const result14 = quickCheckResult(withMaxSuccess(10, forAll(genInt, prop_Good4WithLogging)));
