...
class Args extends Immutable.Record({
    ...
    withReplay(replay) {
        return this.set('replay', replay);
    }
    withMaxSuccess(maxSuccess) {
        return this.set('maxSuccess', maxSuccess);
    }
    withMaxDiscardRatio(maxDiscardRatio) {
        return this.set('maxDiscardRatio', maxDiscardRatio);
    }
    withMaxSize(maxSize) {
        return this.set('maxSize', maxSize);
    }
    withChatty(chatty) {
        return this.set('chatty', chatty);
    }
    withMaxShrinks(maxShrinks) {
        return this.set('maxShrinks', maxShrinks);
    }
}

export const stdArgs = new Args({});
