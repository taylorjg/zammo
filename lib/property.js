...
export const succeeded = new Result(OK_SUCCEEDED, '', true, new Nothing());
export const failed = new Result(OK_FAILURE, '', true, new Nothing());
export const rejected = new Result(OK_REJECTED, '', true, new Nothing());
...
export const withMaxSuccess = (n, p) => mapTotalResult(res => res.withMaybeNumTests(new Just(n)), p);
