...
export const expectFailure = p => mapTotalResult(res => res.withExpect(false), p);
...
// callback :: Testable prop => Callback -> prop -> Property
const callback = (cb, p) => mapTotalResult(res => res.withCallbacks([cb, ...res.callbacks]), p);
...
//         return cbs;
//     };
//     return mapResult(res => res.withCallbacks(newCallbacks(res.callbacks)).concat(res.callbacks));
// };
