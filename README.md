...
* __Running tests__: stdArgs, quickCheck, quickCheckWith, quickCheckWithResult, quickCheckResult,
...
printTestCase, whenFail, whenFail', expectFailure, label, collect, classify, cover, discard, mapSize
